...
echo "WLED Helper - iPad/Tablet via This Computer (Low Latency)"
echo "Starts only the optional WLED helper on your LAN."
echo "Use this when Piano Trainer is running on iPad/tablet through this computer."
echo "Node.js is required for this launcher."
echo
export PIANO_TRAINER_HELPER_HOST=0.0.0.0
